window.docData = {
        ...
        kr: {
            ...
            <div class="space-y-6 text-gray-800 font-inter">
                <div class="bg-gradient-to-r from-red-50 to-orange-50 border-l-4 border-cand-red p-5 rounded-r-xl shadow-sm">
                    ...
                    <p class="text-sm leading-relaxed">안보, 질서 및 사회 안전 분야의 행정 위반 처벌 규정. 베트남 내 <strong>외국인</strong> 및 <strong>외국 단체</strong>와 관련된 위반 행위, 처벌 수준 및 처리 권한을 상세히 규정.</p>
                </div>
                 <div class="bg-white p-4 rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                    <h5 class="font-bold text-gray-900 mb-3 flex items-center gap-2 text-base border-b pb-2 border-gray-100">
                        <span class="bg-cand-red text-white w-6 h-6 rounded-full flex items-center justify-center text-xs">1</span>
                     ...
                     <ul class="text-sm space-y-2 ml-1">
                        <li class="flex gap-2">
                            <i data-lucide="users" class="w-4 h-4 text-cand-red mt-0.5"></i>
                            <span><strong>대상:</strong> 외국인 개인 및 단체. <strong>단체 위반: 개인의 2배</strong> 벌금.</span>
                        </li>
                        <li class="flex gap-2">
                            <i data-lucide="ban" class="w-4 h-4 text-cand-red mt-0.5"></i>
                            <span><strong>특별 처벌:</strong> 경고/벌금 외에 <strong>추방</strong>이 주된 또는 추가 처벌로 적용될 수 있음.</span>
                        </li>
                    </ul>
                </div>
                ...
                <div class="bg-white p-4 rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                    <h5 class="font-bold text-gray-900 mb-3 flex items-center gap-2 text-base border-b pb-2 border-gray-100">
                        <span class="bg-cand-red text-white w-6 h-6 rounded-full flex items-center justify-center text-xs">2</span>
                        출입국 및 거주 위반 (제21조)
                    </h5>
                    <div class="space-y-3 text-sm">
                        <div class="flex items-start gap-2">
                            <i data-lucide="id-card" class="w-4 h-4 text-orange-500 mt-0.5 shrink-0"></i>
                            <div>
                                <strong>신분 증명서:</strong> 여권 미소지(이동 중): <strong class="text-cand-red">30만-50만</strong>. 허위 신고/제한 구역: <strong class="text-cand-red">50만-200만</strong>.
                            </div>
                        </div>
                        <div class="bg-gray-50 p-3 rounded-lg">
                            <strong class="block mb-2 text-gray-900">임시 거주 기간 초과:</strong>
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-2 text-xs">
                                <div class="bg-white p-2 rounded border text-center">
                                    <span class="block text-gray-500">16일 미만</span>
                                    <strong class="text-cand-red">50만-200만</strong>
                                </div>
                                <div class="bg-white p-2 rounded border text-center">
                                    <span class="block text-gray-500">16 - 30일</span>
                                    <strong class="text-cand-red">500만-1천만</strong>
                                </div>
                                <div class="bg-white p-2 rounded border text-center">
                                    <span class="block text-gray-500">30 - 60일</span>
                                    <strong class="text-cand-red">1천만-1500만</strong>
                                </div>
                                <div class="bg-white p-2 rounded border text-center">
                                    <span class="block text-gray-500">60 - 90일</span>
                                    <strong class="text-cand-red">1500만-2천만</strong>
                                </div>
                                <div class="bg-white p-2 rounded border text-center">
                                    <span class="block text-gray-500">90 - 180일</span>
                                    <strong class="text-cand-red">2천만-2500만</strong>
                                </div>
                                <div class="bg-white p-2 rounded border text-center">
                                    <span class="block text-gray-500">180일 - 1년</span>
                                    <strong class="text-cand-red">2500만-3천만</strong>
                                </div>
                                <div class="bg-red-100 p-2 rounded border border-red-200 text-center col-span-2">
                                    <span class="block text-red-700 font-bold">1년 이상</span>
                                    <strong class="text-cand-red text-sm">3천만-4천만 동</strong>
                                </div>
                            </div>
                        </div>
                        <div class="flex items-start gap-2">
                            <i data-lucide="briefcase" class="w-4 h-4 text-blue-500 mt-0.5 shrink-0"></i>
                            <div>
                                <strong>목적 위반:</strong> 무허가 활동: <strong class="text-cand-red">1500만-2천만</strong>. 비자 목적 위반: <strong class="text-cand-red">2천만-2500만</strong>.
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white p-4 rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                    <h5 class="font-bold text-gray-900 mb-3 flex items-center gap-2 text-base border-b pb-2 border-gray-100">
                        <span class="bg-cand-red text-white w-6 h-6 rounded-full flex items-center justify-center text-xs">3</span>
                        단체 및 숙박 시설의 책임
                    </h5>
                    <div class="grid md:grid-cols-2 gap-3 text-xs">
                        <div class="bg-purple-50/50 p-3 rounded-lg border border-purple-100">
                            <strong class="text-purple-700 block mb-1">보증인</strong>
                            <span>책임 불이행 또는 불법 거주자 고용: <strong class="text-cand-red">2천만-2500만 동</strong>.</span>
                        </div>
                        <div class="bg-blue-50/50 p-3 rounded-lg border border-blue-100">
                            <strong class="text-blue-700 block mb-1">숙박 시설</strong>
                            <span>거주 신고 불이행: <strong class="text-cand-red">300만-2천만 동</strong> (인원에 따라 차등).</span>
                        </div>
                        <div class="bg-gray-50 p-3 rounded-lg border border-gray-200 md:col-span-2">
                            <strong class="text-gray-700 block mb-1">경비업</strong>
                            <span>외국인을 경비원으로 고용: <strong class="text-cand-red">500만-1천만 동</strong>.</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white p-4 rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                    <h5 class="font-bold text-gray-900 mb-3 flex items-center gap-2 text-base border-b pb-2 border-gray-100">
                        <span class="bg-cand-red text-white w-6 h-6 rounded-full flex items-center justify-center text-xs">4</span>
                        추방 대상 행위
                    </h5>
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-2 text-xs">
                        <div class="bg-red-50 p-2 rounded-lg text-center border border-red-100">
                            <i data-lucide="alert-triangle" class="w-4 h-4 text-red-500 mx-auto mb-1"></i>
                            <span class="block">공공 질서 침해</span>
                        </div>
                        <div class="bg-red-50 p-2 rounded-lg text-center border border-red-100">
                            <i data-lucide="bomb" class="w-4 h-4 text-red-500 mx-auto mb-1"></i>
                            <span class="block">무기/폭발물 위반</span>
                        </div>
                        <div class="bg-red-50 p-2 rounded-lg text-center border border-red-100">
                            <i data-lucide="ban" class="w-4 h-4 text-red-500 mx-auto mb-1"></i>
                            <span class="block">사회적 악덕(마약 등)</span>
                        </div>
                        <div class="bg-red-50 p-2 rounded-lg text-center border border-red-100">
                            <i data-lucide="shield-alert" class="w-4 h-4 text-red-500 mx-auto mb-1"></i>
                            <span class="block">국가 안보 침해</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-red-50/50 p-4 rounded-xl border border-red-100">
                    <h5 class="font-bold text-gray-900 mb-3 flex items-center gap-2 text-base">
                        ...
                        <li class="flex gap-2">
                            <i data-lucide="user" class="w-4 h-4 text-cand-red mt-0.5"></i>
                            <span><strong>출입국 관리 실장</strong> & <strong>지방 공안 국장:</strong> 벌금 + <strong>추방</strong> 결정 권한.</span>
                        </li>
                        <li class="flex gap-2">
                            <i data-lucide="building-2" class="w-4 h-4 text-cand-red mt-0.5"></i>
                            <span><strong>출입국 관리 국장:</strong> 최고 권한, 추방 결정.</span>
                        </li>
                        <li class="flex gap-2 bg-yellow-50 p-2 rounded-lg border border-yellow-200 mt-2">
                            <i data-lucide="info" class="w-4 h-4 text-yellow-600 mt-0.5 shrink-0"></i>
                            <span class="text-xs"><strong>참고:</strong> 안보상 필요시 벌금 납부 능력과 관계없이 즉시 <strong>추방</strong> 가능.</span>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    doc2: {
        ...
        kr: {
            title: "베트남 내 외국인의 입국, 출국, 경유, 거주에 관한 법률",
            subtitle: "통합 문서 제 30/VBHN-VPQH 호",
            content: `
            <div class="space-y-6 text-gray-800 font-inter">
                <div class="bg-gradient-to-r from-blue-50 to-indigo-50 border-l-4 border-blue-500 p-5 rounded-r-xl shadow-sm">
                        <h4 class="font-bold text-blue-700 text-lg mb-2 flex items-center gap-2">
                        <i data-lucide="book-open" class="w-5 h-5"></i>
                        통합 문서 제 30/VBHN-VPQH 호
                    </h4>
                    <p class="text-sm leading-relaxed">베트남 내 외국인 활동에 대한 포괄적인 법률 규정: 입국, 출국, 경유, 거주의 원칙, 조건 및 절차.</p>
                </div>
                 <div class="bg-white p-4 rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                    <h5 class="font-bold text-gray-900 mb-3 flex items-center gap-2 text-base border-b pb-2 border-gray-100">
                        <span class="bg-blue-100 text-blue-600 w-6 h-6 rounded-full flex items-center justify-center text-xs">1</span>
                    ...
                    <ul class="space-y-3 text-sm ml-2">
                         <li class="flex items-start gap-2">
                            <i data-lucide="shield" class="w-4 h-4 text-blue-500 mt-0.5 shrink-0"></i>
                            <span><strong>원칙:</strong> 주권 및 국가 안보 보장. 관리는 <strong>공개적, 투명, 편리</strong>하면서도 엄격해야 함.</span>
                        </li>
                        <li class="flex items-start gap-2">
                            <i data-lucide="alert-triangle" class="w-4 h-4 text-red-500 mt-0.5 shrink-0"></i>
                            <span><strong>금지:</strong> 불법 입국, 서류 위조, 허위 신고, 반국가 활동.</span>
                        </li>
                    </ul>
                </div>
                 <div class="bg-white p-4 rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                    <h5 class="font-bold text-gray-900 mb-3 flex items-center gap-2 text-base border-b pb-2 border-gray-100">
                     ...
                     <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-3">
                        <div class="bg-gray-50 p-3 rounded-lg">
                            <span class="block font-bold text-blue-600 text-xs mb-1">DL (관광)</span>
                            <span class="text-sm">90일 이하</span>
                        </div>
                        <div class="bg-gray-50 p-3 rounded-lg">
                            <span class="block font-bold text-blue-600 text-xs mb-1">LĐ1, LĐ2 (노동)</span>
                            <span class="text-sm">2년 이하</span>
                        </div>
                        <div class="bg-gray-50 p-3 rounded-lg">
                            <span class="block font-bold text-blue-600 text-xs mb-1">ĐT1 - ĐT4 (투자)</span>
                            <span class="text-sm">01 - 05 년</span>
                        </div>
                        <div class="bg-gray-50 p-3 rounded-lg">
                            <span class="block font-bold text-blue-600 text-xs mb-1">TT (동반)</span>
                            <span class="text-sm">1년 이하</span>
                        </div>
                    </div>
                    <p class="text-sm text-gray-600 italic border-l-2 border-gray-300 pl-3">
                        *투자, 노동, 가족 관계 입증 서류가 있는 경우를 제외하고는 일반적으로 목적 변경 불가.
                    </p>
                 </div>
                ...
                <div class="grid md:grid-cols-2 gap-4">
                    ...
                    <div class="bg-white p-4 rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <ul class="space-y-2 text-sm">
                            <li><strong>조건:</strong> 유효한 여권 및 비자.</li>
                            <li><strong>비자 면제:</strong> 일방적 비자 면제 <strong>45일</strong>.</li>
                            <li><strong>출국 정지:</strong> 사건 연루, 세금 체납, 행정 처벌 미이행.</li>
                        </ul>
                    </div>
                    ...
                    <div class="bg-white p-4 rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <ul class="space-y-2 text-sm">
                            <li><strong>임시 거주:</strong> 전자 포털 또는 지역 공안 신고.</li>
                            <li><strong>거주증:</strong> 2 - 10년 (투자, 노동, 동반).</li>
                            <li><strong>영주권:</strong> 유공자, 전문가, 보증인.</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="bg-blue-50/50 p-4 rounded-xl border border-blue-100">
                    <h5 class="font-bold text-gray-900 mb-3 flex items-center gap-2 text-base">
                        ...
                        <li class="flex gap-2">
                            <i data-lucide="user-check" class="w-4 h-4 text-blue-600 mt-0.5"></i>
                            <span><strong>권리:</strong> 생명, 재산 보호. 친척 초청 보증.</span>
                        </li>
                        <li class="flex gap-2">
                            <i data-lucide="gavel" class="w-4 h-4 text-cand-red mt-0.5"></i>
                            <span><strong>의무:</strong> 법률 준수, 목적에 맞는 활동, 신분증 소지.</span>
                        </li>
                        <li class="flex gap-2">
                            <i data-lucide="building-2" class="w-4 h-4 text-gray-600 mt-0.5"></i>
                            <span><strong>관리:</strong> 공안부(주관), 외교부(외교), 인민위원회(지방).</span>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    doc3: {
        ...
        kr: {
            title: "푸토성 내 외국인 거주 및 활동 관리 협력 규정",
            subtitle: "결정문 제 3518/2025/QĐ-CTUBND 호",
            content: `
            <div class="space-y-6 text-gray-800 font-inter">
                <div class="bg-gradient-to-r from-teal-50 to-emerald-50 border-l-4 border-teal-500 p-5 rounded-r-xl shadow-sm">
                     <h4 class="font-bold text-teal-700 text-lg mb-2 flex items-center gap-2">
                        <i data-lucide="landmark" class="w-5 h-5"></i>
                        결정문 제 3518/2025/QĐ-CTUBND 호
                    </h4>
                    <p class="text-sm leading-relaxed">푸토성 외국인 관리 협력 규정, <strong>2025년 10월 28일</strong>부터 효력 발생. 공안국을 "중추"로 하는 다단계 관리 네트워크 구축.</p>
                </div>
                 <div class="bg-white p-4 rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                    <h5 class="font-bold text-gray-900 mb-3 flex items-center gap-2 text-base border-b pb-2 border-gray-100">
                        <span class="bg-teal-100 text-teal-600 w-6 h-6 rounded-full flex items-center justify-center text-xs">1</span>
                     ...
                     <div class="grid grid-cols-1 gap-2 text-sm">
                        <div class="flex items-center gap-3 bg-gray-50 p-3 rounded-lg">
                            <i data-lucide="shield-check" class="w-5 h-5 text-teal-600 shrink-0"></i>
                            <div>
                                <strong class="text-teal-700">공안국:</strong>
                                <span class="text-gray-600">출입국 및 외국인 거주에 대한 국가 관리 주관.</span>
                            </div>
                        </div>
                        <div class="flex items-center gap-3 bg-gray-50 p-3 rounded-lg">
                            <i data-lucide="briefcase" class="w-5 h-5 text-blue-600 shrink-0"></i>
                            <div>
                                <strong class="text-blue-700">내무국:</strong>
                                <span class="text-gray-600">외국인 노동 관리 주관.</span>
                            </div>
                        </div>
                        <div class="flex items-center gap-3 bg-gray-50 p-3 rounded-lg">
                            <i data-lucide="globe" class="w-5 h-5 text-purple-600 shrink-0"></i>
                            <div>
                                <strong class="text-purple-700">외무국:</strong>
                                <span class="text-gray-600">지방 정부 초청 귀빈 및 영사 업무 관리.</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white p-4 rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <div class="grid md:grid-cols-2 gap-3 text-xs">
                        <div class="bg-blue-50/50 p-3 rounded-lg border border-blue-100">
                            <strong class="text-blue-700 block mb-1">교육청</strong>
                            <span>교육 분야 외국인 관리. 외국인 교사 초청 시 공안국과 협력.</span>
                        </div>
                        <div class="bg-pink-50/50 p-3 rounded-lg border border-pink-100">
                            <strong class="text-pink-700 block mb-1">보건국</strong>
                            <span>매월 <strong>15일 전까지</strong> 공안국에 개업 자격증 보고.</span>
                        </div>
                        <div class="bg-orange-50/50 p-3 rounded-lg border border-orange-100">
                            <strong class="text-orange-700 block mb-1">산업통상국</strong>
                            <span>대표 사무소 관리. 외국인 도착 <strong>7일 전</strong> 보고.</span>
                        </div>
                        <div class="bg-cyan-50/50 p-3 rounded-lg border border-cyan-100">
                            <strong class="text-cyan-700 block mb-1">산업단지 관리 위원회</strong>
                            <span>거주/숙박 계획 검토, 파업 처리.</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid md:grid-cols-2 gap-4">
                    ...
                    <div class="bg-white p-4 rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <ul class="space-y-2 text-xs">
                            <li class="flex gap-2">
                                <i data-lucide="alert-triangle" class="w-3 h-3 text-red-500 mt-0.5 shrink-0"></i>
                                <span><strong>사고/사망:</strong> <strong>12시간 이내</strong> 외무국 통보.</span>
                            </li>
                            <li class="flex gap-2">
                                <i data-lucide="shield" class="w-3 h-3 text-purple-500 mt-0.5 shrink-0"></i>
                                <span><strong>면책 특권 외국인:</strong> 외무국에서 외교적으로 처리.</span>
                            </li>
                            <li class="flex gap-2">
                                <i data-lucide="log-out" class="w-3 h-3 text-cand-red mt-0.5 shrink-0"></i>
                                <span><strong>추방:</strong> 공안국 주관 집행.</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="bg-white p-4 rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <ul class="space-y-2 text-xs">
                            <li>• <strong>매월:</strong> 15일 전 → 공안국.</li>
                            <li>• <strong>6개월:</strong> 6월 15일 전 → 출입국 관리실.</li>
                            <li>• <strong>연간:</strong> 12월 15일 전 → 출입국 관리실.</li>
                            <li>• <strong>거주 신고:</strong> 공안부 온라인 포털.</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="bg-teal-50/50 p-4 rounded-xl border border-teal-100">
                    <h5 class="font-bold text-gray-900 mb-3 flex items-center gap-2 text-base">
                        ...
                        <li class="flex gap-2">
                            <i data-lucide="megaphone" class="w-4 h-4 text-teal-600 mt-0.5"></i>
                            <span>베트남 법률 홍보 협력, 위반 예방.</span>
                        </li>
                        <li class="flex gap-2">
                            <i data-lucide="handshake" class="w-4 h-4 text-teal-600 mt-0.5"></i>
                            <span>피보증인 관련 사건 발생 시 해결 협력.</span>
                        </li>
                    </ul>
                </div>
            </div>
